...
void Scribble::antiAliasing(RenderTextureExt *pRenderTexture){
    pRenderTexture->getSprite()->getTexture()->setAntiAliasTexParameters();
}

void Scribble::disAntiAliasing(RenderTextureExt *pRenderTexture){
...
void Scribble::paint(Sprite *pTarget, RenderTextureExt *pCanvas, Point pPosition){
    vector<Point> lPositions;
    lPositions.push_back(pPosition);
    this->paint(pTarget, pCanvas, lPositions);
}

void Scribble::paint(Sprite *pTarget, RenderTextureExt *pCanvas, Point pStartPosition, Point pEndPosition){
    Sprite *lBrush = this->getBrush();
...
void Scribble::paint(Sprite *pTarget, RenderTextureExt *pCanvas, vector<Point> pWorldPositions){
    Sprite *lBrush = this->getBrush();
...
void Scribble::removeTargetObserver(RenderTextureExt *pTarget){
